      ...
      await route.fulfill({
        ...
        body: JSON.stringify({
          entries: [
            ...
            { id: '2', name: 'JP Mitra', timeMs: 2980, eventFeet: 100, device: 'Android', ppi: 96, country: 'KR', completedAt: '' },
            ...
            { id: '5', name: 'Mild Comet', timeMs: 5125, eventFeet: 100, device: 'iPhone', ppi: 160, country: 'JP', completedAt: '' },
            { id: '6', name: 'Rogue Swift', timeMs: 5680, eventFeet: 100, device: 'Android', ppi: 120, country: 'FR', completedAt: '' },
          ],
          total: 1287,
        }),
      })
